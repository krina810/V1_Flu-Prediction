...
$link = mysqli_connect('localhost','root', '')or die( " Unable to CONNECT to server, administrators will be notified and check this problem soon. We apologize for the inconvenience. ");
$db_name = 'flu';
$correct_secret_word = 'php_var_correct_secret_word';
...
if (isset( $_GET['secretinstall'])) {
    ...
    mysql_query("INSERT INTO flu_engine (cache_url, consumer_key, consumer_secret ) VALUES ('?since_id=**********************&q=flu%20OR%20chills%20OR%20sore%20throat%20OR%20headache%20OR%20runny%20nose%20OR%20sneazing%20OR%20fever%20OR%20flu%20shot%20OR%20flushot%20OR%20dry%20cough&result_type=recent&include_entities=1', '***************', '********************************************')");
...
$selected = mysqli_select_db($link, $db_name) or die("Unable to SELECT database, administrators will be notified and check this problem soon. We apologize for the inconvenience.");
